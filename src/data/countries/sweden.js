export const sweden = [
  ...
  { name: "Prinsesstårta", desc: "Layer cake with sponge, jam, custard, and a green marzipan dome." },
  { name: "Kräftskiva (Crayfish)", desc: "Boiled crayfish seasoned with dill, eaten at late summer parties." },
  { name: "Ärtsoppa & Pannkakor", desc: "Yellow pea soup followed by pancakes, a Thursday tradition." }
];
